...
class RegisterUserForm(forms.ModelForm):
    ...
    password1 = forms.CharField(label='Password', widget=forms.PasswordInput, help_text='Put password')
    password2 = forms.CharField(label='Password', widget=forms.PasswordInput, help_text='Put the same password again')
    ...
    def clean(self):
        ...
        if password1 and password2 and password1 != password2:
            errors = {'password2': ValidationError('Passwords are not equal', code='password_mismatch')}
